...
|--------|------:|---------:|------:|----------:|
| **TUI-based** (30+ semantic type mappings, hand-curated) | 66 | 18 | 31 | **78.57%** |
| **Semantic Groups** (NIH official 15 groups; 7 classes × 1-3) | 80 | 29 | 6 | **73.39%** |

## Method Agreement

- Both methods MATCH: 66
- Both methods MISMATCH: 9
