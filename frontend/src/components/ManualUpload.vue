...
// Stages: idle → extracting → reviewing → saving → saved | error
...
<template>
  <section class="page">
    ...
    <ol class="rail">
      ...
      <li :class="{ active: stage === 'reviewing' || stage === 'saving', done: stage === 'saved' }">
        <span class="rail-num">2</span>
        <span class="rail-lbl">Review</span>
      </li>
      <li :class="{ active: stage === 'saved' }">
    ...
    <div class="grid">
      ...
      <div class="card result">
        <header class="card-head">
          <h3>{{ stage === 'saved' ? 'Saved to ontology' : 'Review &amp; approve' }}</h3>
        ...
        <template v-else-if="stage === 'reviewing' || stage === 'saving'">
          ...
          <footer class="approve-bar">
            ...
            >
              ...
              {{ stage === 'saving' ? 'Saving…' : `Save ${checkedCount.entities + checkedCount.relations} approved items` }}
        ...
        <!-- SAVED -->
        <template v-else-if="stage === 'saved' && saveResult">
