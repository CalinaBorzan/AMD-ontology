...
5. **Outcome coverage**: verify every disease has at least one hasSymptom triple pointing to a ClinicalOutcome. Common outcomes to check for: Blindness, VisionLoss, VisualImpairment, CentralVisionLoss, disease-progression events.
6. **Target vs biomarker**: VEGF and related molecular targets (VEGF-A/B/C, VEGFR1/2, S1P, complement C3, PDGF) must live in MolecularTarget, NOT Biomarker. Biomarker holds measurable indicators (drusen, retinal thickness, serum lutein).

RETENTION RULE: Never remove an existing class, property, or individual. Only add.

ADDITIONAL RULES:
- NAMING: CamelCase, NO spaces/dashes/slashes/parentheses/apostrophes. Valid: ChoroidalNeovascularization, VitaminC. Invalid: "Vitamin C", "Alzheimer's disease", "TNF-a".
...
- CANONICALIZATION: pick ONE name per concept; map synonyms, abbreviations, and British vs American spellings to the same entity.
- SKIP study acronyms (LUCAS, MARINA, ANCHOR, ASPREE, AURA Study, RETILASE, FAM-Study, PrONTO) and anything ending in Study/Trial/Survey/Cohort/Registry. Skip institutions, places, persons.
